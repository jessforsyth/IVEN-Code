function [cell_id,x,y,z,ch1,ch2,ch3,ch4,ch2_adj,ch3_adj,ch4_adj,outside,nbrs_new,nbr_comp,med_nbr_dist]=import_nbr_file_python(table,headings);
...
%data. 
    ...
    nbrs_new=table(headings:end,13);
    nbr_comp=table(headings:end,14);
    med_nbr_dist=table(headings:end,15);
